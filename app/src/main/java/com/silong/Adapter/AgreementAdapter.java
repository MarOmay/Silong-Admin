...
public class AgreementAdapter extends RecyclerView.Adapter<AgreementAdapter.ViewHolder> {
    ...
    public AgreementAdapter( AgreementData[] agreementData, Activity activity){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        final AgreementData agreement = agreementData[position];
        holder.agreementTitle.setText(agreement.getAgreementTitle());
        holder.agreementBody.setText(agreement.getAgreementBody());
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(activity, EditClause.class);
                intent.putExtra("agreementData", (Serializable) agreement);
