...
import com.silong.admin.AdoptionRecords;
import com.silong.admin.R;

import java.util.Calendar;

public class DateRangePickerReport extends MaterialAlertDialogBuilder {

    public String newFromDate = AdoptionRecords.dateFrom
            , newToDate = AdoptionRecords.dateTo;
    ...
    public DateRangePickerReport(@NonNull Activity activity){
        ...
        super.setPositiveButton(Html.fromHtml("<b>"+"APPLY"+"</b>"), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (from.after(to)){
                    ...
                    //set new values
                    AdoptionRecords.dateFrom = newFromDate;
                    AdoptionRecords.dateTo = newToDate;
                    AdoptionRecords.customDate = true;
                    LocalBroadcastManager.getInstance(activity).sendBroadcast(new Intent("refresh-records"));
                }
