...
public class Spreadsheet {
    ...
    public Workbook create(){
        ...
        try {
            ...
            //Object[] headerData = new Object[]{"City Veterinary Office - City of San Jose del Monte"};
            //formData.put(String.valueOf(ctrRow), headerData);
            //ctrRow++;

            int rowid = 0;

            Row headerRow = null;
            Object[][] headerData = new Object[][]{{"Company:", "City Veterinary Office - City of San Jose del Monte"}, {"Report:", title}};
            for (Object[] objArr : headerData){
                headerRow = spreadsheet.createRow(rowid++);
                int tempCellid = 0;

                for (Object obj : objArr){
                    Cell cell = headerRow.createCell(tempCellid++);
            ...
            Row fieldRow = spreadsheet.createRow(rowid++);
            int fieldCellid = 0;
            for (Object obj : entries.get(0)){
                Cell cell = fieldRow.createCell(fieldCellid++);
                cell.setCellValue((String) obj);
            }
            entries.remove(0);
            ...
            String adminSignature = "EMAIL_NOT_AVAILABLE";
            if (AdminData.firstName != null && AdminData.lastName != null){
                adminSignature = AdminData.firstName + " " + AdminData.lastName;
            }
            else if (AdminData.adminEmail != null){
                adminSignature = AdminData.adminEmail;
            }
            ...
            genCell.setCellValue("Generated by: " + adminSignature);
